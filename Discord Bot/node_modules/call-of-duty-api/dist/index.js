...
exports.Misc = exports.Me = exports.Store = exports.Vanguard = exports.ColdWar = exports.ModernWarfare = exports.Warzone = exports.platforms = exports.login = void 0;
...
;
const sendRequest = (url) => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    try {
        if (!loggedIn)
...
class WZ {
    constructor() {
        this.fullData = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
        ...
        this.combatHistory = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.combatHistoryWithDate = (gamertag, startTime, endTime, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.breakdown = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.breakdownWithDate = (gamertag, startTime, endTime, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.matchInfo = (matchId, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
...
class MW {
    constructor() {
        ...
        this.seasonloot = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Steam)
                throw new Error("Steam Doesn't exist for MW. Try `battle` instead.");
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
        ...
        this.mapList = (platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
...
class SHOP {
    constructor() {
        this.purchasableItems = (gameId) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return yield sendRequest(`/inventory/v1/title/${gameId}/platform/psn/purchasable/public/en`);
        });
        this.bundleInformation = (title, bundleId) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return yield sendRequest(`/inventory/v1/title/${title}/bundle/${bundleId}/en`);
        });
        this.battlePassLoot = (season, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
...
class USER {
    constructor() {
        this.friendFeed = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
        ...
        this.eventFeed = () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return yield sendRequest(`/userfeed/v1/friendFeed/rendered/en/${baseSsoToken}`);
        });
        this.loggedInIdentities = () => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            return yield sendRequest(`/crm/cod/v2/identities/${baseSsoToken}`);
        });
        this.codPoints = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
        ...
        this.connectedAccounts = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            let lookupType = "gamer";
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno)
        ...
        this.settings = (gamertag, platform) => (0, tslib_1.__awaiter)(this, void 0, void 0, function* () {
            if (platform === platforms.Battlenet || platform === platforms.Activision || platform === platforms.Uno)
                gamertag = cleanClientName(gamertag);
            if (platform === platforms.Uno || platform === platforms.Activision)
                platform = platforms.Uno;
